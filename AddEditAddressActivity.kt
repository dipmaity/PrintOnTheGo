...
import com.example.plk.databinding.ActivityAddEditAddressBinding
...
class AddEditAddressActivity : StartActivity() {
    ...
    private var mAddressDetails: Thikana? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mAddressDetails != null) {
            if (mAddressDetails!!.id.isNotEmpty()) {
                ...
                binding.aaaTvTitle.text = resources.getString(R.string.title_edit_address)
